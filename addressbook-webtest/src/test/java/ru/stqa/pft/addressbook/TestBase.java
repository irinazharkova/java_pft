...
public class TestBase {
  ...
  public void setUp() throws Exception {
    ...
    TestBase.login(wd, "admin", "secret");
  }
  ...
  protected void deleteSelectedGroupd() {
  ...
  protected void fillContactForm(ContactData contactData) {
    ...
    wd.findElement(By.name("home")).sendKeys(contactData.home_number());
    wd.findElement(By.name("mobile")).click();
    wd.findElement(By.name("mobile")).clear();
    wd.findElement(By.name("mobile")).sendKeys(contactData.mobile_nubmer());
